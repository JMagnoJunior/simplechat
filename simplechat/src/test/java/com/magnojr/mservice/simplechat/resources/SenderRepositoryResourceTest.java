...
public class SenderRepositoryResourceTest {
	...
	@Test
	public void whenCallResourceSenders_shouldExists() throws Exception {
		mvc.perform(get("http://localhost:8080/senders").contentType(MediaType.APPLICATION_JSON))
